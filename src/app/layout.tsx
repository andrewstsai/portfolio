...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={crimson.variable} suppressHydrationWarning>
      ...
      <body className="bg-white text-neutral-900 transition-colors duration-200 dark:bg-neutral-950 dark:text-neutral-100">
        <a
          href="#main-content"
        ...
        <main className="site-main mx-auto w-full max-w-screen-sm min-h-[100lvh] pb-[calc(env(safe-area-inset-bottom)+6rem)] md:max-w-screen-md md:min-h-0 md:pb-0 lg:max-w-screen-lg xl:max-w-screen-2xl md:flex md:h-dvh md:flex-col">
          <Nav />
