...
export default function ContactList() {
  return (
    <ul className="contact-list mt-auto flex flex-col border-b border-neutral-200 pt-4 dark:border-neutral-700">
      {contacts.map((c) => {
        const isMail = c.icon === "mail";
        return (
          <li key={c.label} className="contact-item border-t border-neutral-200 dark:border-neutral-700">
            <a
              href={c.href}
            ...
            >
              ...
              <span className="flex min-w-0 items-center gap-2">
                <span className="truncate text-sm tracking-tight text-neutral-400 dark:text-neutral-500">
                  {c.handle}
                </span>
                <svg
                  aria-hidden="true"
